 ...
 */
function generateSaga(name, options) {
  const config = Config(options);

  let target = path.join(config.srcDir, 'sagas', name + '.js');
  ...
  utils.copyAndReplace(path.join(__dirname, '../templates/saga/index.js'), target, {
